...
BLOCKING: true
FIELDS:
  - dotfile_emit_events: bool
  - dotdir_recurse: bool
CONTEXT_NEEDED:
  - watchdog library defaults to emitting events for all paths; the
    plan needs an explicit project decision so M2 acceptance criteria
    can be written
===END_OF_MESSAGE===
